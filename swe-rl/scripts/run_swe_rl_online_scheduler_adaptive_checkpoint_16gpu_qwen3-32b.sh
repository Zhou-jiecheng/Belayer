...
# SWE-RL online scheduler + adaptive checkpoint training (Qwen3-32B) on 2 nodes / 16 GPUs.
# Scheduler should inject:
#   MLP_ROLE_INDEX=0/1
#   MLP_WORKER_0_HOST=<head_ip>
#   MLP_WORKER_1_HOST=<worker_ip>
#
# Both nodes run this same script. The first node is treated as MASTER_ADDR / Ray head.
...
exec "${LAUNCH_SCRIPT_DIR}/run_swe_rl_online_scheduler_adaptive_checkpoint_16gpu_qwen3-32b.sh" "$@"
