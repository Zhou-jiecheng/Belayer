...
# SWE-RL static-concurrency baseline (256), checkpoint enabled, on 2 nodes / 16 GPUs.
...
exec "${LAUNCH_SCRIPT_DIR}/run_swe_rl_static_checkpoint_256_16gpu_qwen3-32b.sh" "$@"
