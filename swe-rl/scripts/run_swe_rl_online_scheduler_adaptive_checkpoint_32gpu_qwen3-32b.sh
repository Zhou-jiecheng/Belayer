...
# SWE-RL online scheduler + adaptive checkpoint training (Qwen3-32B) on 4 nodes / 32 GPUs.
...
exec "${LAUNCH_SCRIPT_DIR}/run_swe_rl_online_scheduler_adaptive_checkpoint_32gpu_qwen3-32b.sh" "$@"
