...
SLIME_ROUTER_DISABLE_TOKEN_LEVEL_RECOVERY="${SLIME_ROUTER_DISABLE_TOKEN_LEVEL_RECOVERY:-0}"

SLIME_ROUTER_GENERATE_PATH="${SLIME_ROUTER_GENERATE_PATH:-"/generate"}"

CI_FAULT_INJECTION_ENABLE="${CI_FAULT_INJECTION_ENABLE:-0}"
CI_FAULT_INJECTION_DELAY_SEC="${CI_FAULT_INJECTION_DELAY_SEC:-30}"
...
CI_FAULT_INJECTION_MID_DELAY_SEC="${CI_FAULT_INJECTION_MID_DELAY_SEC:-30}"
CI_FAULT_INJECTION_ENGINE_INDEX="${CI_FAULT_INJECTION_ENGINE_INDEX:-1}"
CI_FAULT_INJECTION_MID_FALLBACK_SEC="${CI_FAULT_INJECTION_MID_FALLBACK_SEC:-40}"
...
WORKDIR="${WORKDIR:-${SLIME_ROOT}/workdir/slime_no_fast_restart_weight_update_smoke_32gpu_${RUN_ID}}"
    ...
    RUNTIME_ENV_JSON="$(cat <<EOF
{
  "env_vars": {
    ...
    "SLIME_ROUTER_GENERATE_PATH": "${SLIME_ROUTER_GENERATE_PATH}",
    ...
    "SLIME_ROUTER_DISABLE_TOKEN_LEVEL_RECOVERY": "${SLIME_ROUTER_DISABLE_TOKEN_LEVEL_RECOVERY}",
    "PYTHONUNBUFFERED": "1"
  }
}
EOF
    ...
    echo "NO FAST RESTART + WEIGHT UPDATE 32-GPU SMOKE TEST PASSED"
