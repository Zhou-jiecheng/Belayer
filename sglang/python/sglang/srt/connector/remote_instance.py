...
def _get_remote_instance_process_group_timeout() -> datetime.timedelta:
    timeout_sec = max(1.0, float(os.getenv("SLIME_REMOTE_INSTANCE_PROCESS_GROUP_TIMEOUT_SEC", "15")))
    return datetime.timedelta(seconds=timeout_sec)
    ...
    def build_group(
        ...
        try:
            self._model_update_group = init_custom_process_group(
                ...
                timeout=_get_remote_instance_process_group_timeout(),
