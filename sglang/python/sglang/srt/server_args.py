...
class ServerArgs:
    ...
    weight_load_port: Optional[int] = None
    ...
    def add_cli_args(parser: argparse.ArgumentParser):
        ...
        parser.add_argument(
            "--skeleton-worker",
            action="store_true",
            help="Run as a shadow/skeleton worker waiting for takeover.",
        )
        parser.add_argument(
            "--tokenizer-mode",
            type=str,
        ...
        parser.add_argument(
            "--weight_load_port",
            type=int,
            default=ServerArgs.weight_load_port,
            help="Port of the checkpoint-engine persistent parameter server for --load-format weight_deamon.",
        )
