...
def execute():
    ...
    rollout_args = (
        ...
        "--save-debug-rollout-data /mnt/shared-storage-user/ailab-sys/zhoujiecheng/projs/robust_rl/OpenClaw-RL/slime/debug_data/prime_code_format_reward/Qwen2.5-7B-Instruct-multi-turn-no-fault-inject-max-turn-1/data_{rollout_id}.pt "
    )
